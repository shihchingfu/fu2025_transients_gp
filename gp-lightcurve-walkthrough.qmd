...
This notebook accompanies "New metrics for identifying variables and transients in large astronomical surveys" (Fu et al. 2024).
...
```{r}
#| fig-asp: 1
mcmc_pairs(output$draws(variables = hyperparam_names), 
           off_diag_fun = "hex")
```
...
psds_df |>
  ...
  labs(x = "Frequency", y = "Spectral Density", colour = "Kernel") +
  scale_colour_manual(values = c(
    "SE" = "darkgreen",
    "Matern 3/2" = "brown",
    "Periodic" = "darkorange"
